...
REM Also, the script takes around 42 seconds to complete all startups.
...
@REM echo Closing React frontend...
@REM taskkill /fi "WINDOWTITLE eq Frontend" /f > nul
@REM timeout /t 2 /nobreak > nul

@REM echo Closing Spring Boot backend...
@REM taskkill /fi "WINDOWTITLE eq Backend" /f > nul
@REM timeout /t 2 /nobreak > nul
